...
public class RetroPlanksFenceGateBlock extends TriomodmcreatorModElements.ModElement {
	@ObjectHolder("triomodmcreator:retro_planks_fence_gate")
	public static final Block block = null;
	public RetroPlanksFenceGateBlock(TriomodmcreatorModElements instance) {
		super(instance, 18);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("retro_planks_fence_gate");
		}

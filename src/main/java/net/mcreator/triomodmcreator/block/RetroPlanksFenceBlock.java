...
public class RetroPlanksFenceBlock extends TriomodmcreatorModElements.ModElement {
	@ObjectHolder("triomodmcreator:retro_planks_fence")
	public static final Block block = null;
	public RetroPlanksFenceBlock(TriomodmcreatorModElements instance) {
		super(instance, 17);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("retro_planks_fence");
		}

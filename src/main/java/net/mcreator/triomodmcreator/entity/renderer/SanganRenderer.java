...
public class SanganRenderer {
	...
	public static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(SanganEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelsangan(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("triomodmcreator:textures/sangan.png");
					}
				};
			});

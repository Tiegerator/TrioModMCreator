...
public class GameboyEntity extends TriomodmcreatorModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			...
			.size(0.6f, 1.8f)).build("gameboy").setRegistryName("gameboy");
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -9737365, -9582973, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("gameboy_spawn_egg"));
	}

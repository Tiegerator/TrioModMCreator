...
public class IronHammerItem extends TriomodmcreatorModElements.ModElement {
	@ObjectHolder("triomodmcreator:iron_hammer")
	public static final Item block = null;
	public IronHammerItem(TriomodmcreatorModElements instance) {
		super(instance, 50);
	}

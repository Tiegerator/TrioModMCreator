...
import net.mcreator.triomodmcreator.procedures.SanganCardWennMitDerRechtenMaustasteAufEinenBlockGeklicktWurdeProcedure;
...
public class SanganCardItem extends TriomodmcreatorModElements.ModElement {
	...
	public static class ItemCustom extends Item {
		...
		public ActionResultType onItemUseFirst(ItemStack stack, ItemUseContext context) {
			...
			ItemStack itemstack = context.getItem();
			{
				...
				SanganCardWennMitDerRechtenMaustasteAufEinenBlockGeklicktWurdeProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}

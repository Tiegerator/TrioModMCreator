...
public class IronRapierItem extends TriomodmcreatorModElements.ModElement {
	@ObjectHolder("triomodmcreator:iron_rapier")
	public static final Item block = null;
	public IronRapierItem(TriomodmcreatorModElements instance) {
		super(instance, 108);
	}

...
import net.mcreator.triomodmcreator.entity.renderer.RetroShurikenRenderer;
import net.mcreator.triomodmcreator.TriomodmcreatorModElements;

import java.util.Random;

@TriomodmcreatorModElements.ModElement.Tag
public class RetroShurikenItem extends TriomodmcreatorModElements.ModElement {
	@ObjectHolder("triomodmcreator:retro_shuriken")
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(SuperDuperCreativeTabItemGroup.tab).maxDamage(333));
			setRegistryName("retro_shuriken");
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(RetroShurikenItem.block, (int) (1));
		}
	...
	public static ArrowCustomEntity shoot(World world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		...
		world.playSound((PlayerEntity) null, (double) x, (double) y, (double) z,
				(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.metal.hit")), SoundCategory.PLAYERS,
